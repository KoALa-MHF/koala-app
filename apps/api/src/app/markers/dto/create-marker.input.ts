...
import { DEFAULT_COLOR, DEFAULT_CONTENT_COLOR, MarkerType } from '../entities/marker.entity';
...
export class CreateMarkerInput {
  ...
  @Field({ defaultValue: DEFAULT_CONTENT_COLOR, description: 'Marker Content Color' })
  contentColor?: string;
